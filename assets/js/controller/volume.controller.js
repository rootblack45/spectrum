...
class VolumeController {
    ...
    constructor() {
        ...
        this.#volumePanel.mousePressed(this.#mousePressedVolumeSlider.bind(this))
    ...
    draw() {
        if (this.#muted || this.#volume === 0) {
            ...
            const volumeSliderBounds = this.#volumeSlider.elt.getBoundingClientRect()

            const maxVolumePanelWidth = volumePanelBounds.width - volumeSliderBounds.width
            const maxVolumePanelWidthPercent = (maxVolumePanelWidth / volumePanelBounds.width) * 100

            this.#volumeSlider.style("left", `${this.#volume * maxVolumePanelWidthPercent}%`)
        }
    ...
    #mousePressedVolumeSlider() {
        ...
        let volume = ((mouseX - (volumeSliderBounds.width / 2)) - volumePanelBounds.left) / maxVolumePanelWidth
